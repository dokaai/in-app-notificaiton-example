...
export function Navbar() {
  ...
  const unreadCount = useDemoStore((state) => state.unreadCount);
  const socketStatus = useDemoStore((state) => state.socketStatus);
  const setSocketStatus = useDemoStore((state) => state.setSocketStatus);
  const bumpSocketSubscriptionNonce = useDemoStore((state) => state.bumpSocketSubscriptionNonce);
